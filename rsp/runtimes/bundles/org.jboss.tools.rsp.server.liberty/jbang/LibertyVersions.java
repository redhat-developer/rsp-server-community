...
public class LibertyVersions {
    ...
    private static void ensureVersionAdded(String singleAddition, JsonObject serversGson) {
        ...
        String serverTypeKey = "org.jboss.ide.eclipse.as.server.liberty." + majorDotMinorDotMicro(singleAddition);
        ...
        if( typeObj == null ) {
            ...
            generatedType.addProperty("template", "liberty.template");
            ...
            majorDiscoveryVal.addProperty("discoveryType", "properties");
            majorDiscoveryVal.addProperty("name", "WebSphere Liberty " + major(singleAddition) + ".x");
            majorDiscoveryVal.addProperty("nameFile", "lib/versions/openliberty.properties");
            majorDiscoveryVal.addProperty("nameKey", "com.ibm.websphere.productId");
            majorDiscoveryVal.addProperty("nameRequiredPrefix", "io.openliberty");
            majorDiscoveryVal.addProperty("versionFile", "lib/versions/openliberty.properties");
            majorDiscoveryVal.addProperty("versionKey", "com.ibm.websphere.productVersion");
            majorDiscoveryVal.addProperty("versionRequiredPrefix", major(singleAddition) + ".0.");
            ...
            generatedDownloads.addProperty("downloadProviderId", "liberty" + major(singleAddition) + ".0.x");
            generatedType.add("downloads", generatedDownloads);

            JsonObject generatedInnerType = new JsonObject();
            generatedInnerType.addProperty("name", "WebSphere Liberty " + major(singleAddition) + ".0.x");
            String descString = "A server adapter capable of discovering and controlling a WebSphere Liberty " + major(singleAddition) + ".x runtime instance.";
        ...
        String dlKey = "liberty" + singleAddition;
        if( downloadsForType.get(dlKey) == null ) {
            ...
            if( size > -1 ) {
                ...
                generatedDownload.addProperty("name", "WebSphere Liberty " + singleAddition);
                generatedDownload.addProperty("fullVersion", singleAddition);
                generatedDownload.addProperty("downloadUrl", dlUrl);
                generatedDownload.addProperty("licenseUrl", "https://public.dhe.ibm.com/ibmdl/export/pub/software/websphere/wasdev/license/base_ilan/ilan/" + singleAddition + "/lafiles/en.html");
    ...
    public static String getDownloadUrl(String fullVersion) {
        return "https://public.dhe.ibm.com/ibmdl/export/pub/software/websphere/wasdev/downloads/wlp/" + fullVersion + "/wlp-javaee8-" + fullVersion + ".zip";
    }
    ...
    private static String majorDotMinorDotMicro(String v) {
        String[] segments = v.split("\\.");
        String k = segments[0] + "." + segments[1] + "." + segments[2];
        return k;
    }
    ...
    public static String[] findAllVersionsFromWebArchive() {
        ...
        try {
            URL oracle = new URL("https://public.dhe.ibm.com/ibmdl/export/pub/software/websphere/wasdev/downloads/wlp/");

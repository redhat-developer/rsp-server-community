...
public class PayaraServerDelegate extends GenericServerBehavior implements IServerDelegate {

	public PayaraServerDelegate(IServer server, JSONMemento behaviorMemento) {
	...
	public String[] getDeploymentUrls(String strat, String baseUrl, String deployableOutputName, DeployableState ds) {
		return new PayaraContextRootSupport().getDeploymentUrls(strat, baseUrl, deployableOutputName, ds); 
	}

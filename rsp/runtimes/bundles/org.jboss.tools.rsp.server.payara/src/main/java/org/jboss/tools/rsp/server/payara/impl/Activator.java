...
import org.jboss.tools.rsp.server.payara.servertype.impl.IPayaraServerAttributes;

public class Activator extends GenericServerActivator {
	public static final String BUNDLE_ID = "org.jboss.tools.rsp.server.payara";

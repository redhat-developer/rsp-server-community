...
public class GlassfishServerDelegate extends GenericServerBehavior implements IServerDelegate {

	public GlassfishServerDelegate(IServer server, JSONMemento behaviorMemento) {

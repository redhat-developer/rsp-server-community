...
public class GlassfishServerMain extends ServerManagementServerLauncher {

	public static void main(String[] args) throws Exception {
		GlassfishServerMain instance = new GlassfishServerMain(args[0]);
		LauncherSingleton.getDefault().setLauncher(instance);
		instance.launch();
		instance.shutdownOnInput();
	}
	
	public GlassfishServerMain(String string) {
		super(string);
	}

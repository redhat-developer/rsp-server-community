...
public class GlassfishContextRootSupport extends ContextRootSupport {
	...
	protected String[] getCustomWebDescriptorsRelativePath() {
		return new String[] { "glassfish-web.xml", "sun-web.xml", 
				"WEB-INF/glassfish-web.xml", "WEB-INF/sun-web.xml"};
	}
}
